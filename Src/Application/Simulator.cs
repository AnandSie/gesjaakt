...
public class Simulator : ISimulator
{
    ...
    private static void SaveGameResults(Dictionary<string, int> resultPerPlayer, IGameDealer<IGesjaaktReadOnlyPlayer> dealer)
    {
    ...
    private void ReportGameResults(IGameDealer<IGesjaaktReadOnlyPlayer> dealer)
    {
        var winner = dealer.Winner();
